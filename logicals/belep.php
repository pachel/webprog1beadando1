...
if(isset($_POST['felhasznalo']) && isset($_POST['jelszo'])) {
    try {
        ...
        $row = $db->query("select id, csaladi_nev, uto_nev from felhasznalok where bejelentkezes = :bejelentkezes and jelszo = sha1(:jelszo)")->params(['bejelentkezes' => $_POST['felhasznalo'], 'jelszo' => $_POST['jelszo']])->line();
        if(!empty($row)) {
