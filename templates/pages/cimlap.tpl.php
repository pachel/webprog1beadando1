...
<p class="lead">A tanulást segítő weboldal egy interaktív platform, amely lehetőséget biztosít a felhasználók számára,
    hogy különböző témákban teszteljék tudásukat. Az oldal fő funkciója, hogy űrlapok segítségével kérdéseket tegyen
    fel, amelyeket a felhasználók megválaszolhatnak, majd azonnali visszajelzést kapnak a helyességükről. Az alábbiakban
    bemutatjuk az oldal működését és főbb funkcióit.</p>

<div class="accordion" id="accordionExample">
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                    data-bs-target="#felhasznaloiFelulet">
    ...
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#kerdesekValaszok">
    ...
    <div class="accordion-item">
        <h2 class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                    data-bs-target="#ellenorzesErtekeles">
...
<div class="mt-5">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="ratio ratio-16x9">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/1JFAqBIJVUQ?si=Mm7bnfJ18JGSnrfy"
    ...
    <div class="row mt-3">
        <div>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d839.4652554904094!2d20.25930526967479!3d46.845100915475236!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNDbCsDUwJzQyLjQiTiAyMMKwMTUnMzUuOCJF!5e1!3m2!1shu!2shu!4v1740652308654!5m2!1shu!2shu"
